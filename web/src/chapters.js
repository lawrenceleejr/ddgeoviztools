...
//
// Units: camera positions/targets in metres (scene root is scaled 0.001 from
...
export const chapters = [
  {
    ...
    hint: 'Scroll',
    camera: { pos: [9.5, 5.0, 14.0], target: [0, 0, 0], fov: 32 },
  ...
  },
  {
    ...
    camera: { pos: [0.55, 0.32, 0.95], target: [0, 0, 0.05], fov: 30 },
    state: { focus: ['beampipe', 'vertex'], ghost: 0.06, explode: { 'layers.Vertex': 1, 'disks.Vertex': 1 } },
    labels: [
      { at: [0, 102, 0], text: 'r = 102 mm', name: 'Layer 5' },
      { at: [0, 30, 0], text: 'r = 30 mm', name: 'Layer 1' },
  ...
  },
  {
    ...
    camera: { pos: [3.2, 1.6, 4.8], target: [0, 0, 0.4], fov: 30 },
    state: { focus: ['tracker', 'vertex', 'beampipe'], ghost: 0.06, explode: { 'layers.InnerTrackers': 1, 'disks.InnerTrackers': 1 } },
    labels: [
      { at: [0, 554, 0], text: 'r = 554 mm', name: 'Layer 3' },
      { at: [0, 127, 0], text: 'r = 127 mm', name: 'Layer 1' },
      { at: [0, 400, 2187], text: '|z| = 2.19 m', name: 'Disk 7' },
    ],
  },
  {
    id: 'outer',
    ...
    camera: { pos: [6.5, 2.6, 6.0], target: [0, 0, 0], fov: 32 },
    state: { focus: ['tracker'], ghost: 0.06, explode: { 'layers.OuterTrackers': 1, 'disks.OuterTrackers': 1 } },
    labels: [
      { at: [0, 1486, -1600], text: 'r = 1 486 mm', name: 'Layer 3' },
      { at: [0, 1153, 0], text: 'r = 1 153 mm', name: 'Layer 2' },
      { at: [0, 819, 1600], text: 'r = 819 mm', name: 'Layer 1' },
    ],
  },
  {
    id: 'solenoid',
    ...
    camera: { pos: [-5.5, 2.2, 7.5], target: [0, 0, 0], fov: 34 },
    state: { focus: ['solenoid'], ghost: 0.08, explode: {} },
    labels: [
  ...
  },
  {
    ...
    camera: { pos: [7.5, 5.0, 8.5], target: [0, 0.4, 0], fov: 34 },
    state: { focus: ['ecal'], ghost: 0.08, explode: { 'staves.ecal': 1, 'endcaps.ecal': 1 } },
    labels: [
      { at: [0, 2125, 0], text: 'r = 2 125 mm', name: 'Stave' },
      { at: [1200, 1200, 2575], text: '|z| = 2.57 m', name: 'Endcap' },
    ],
  },
  {
    id: 'hcal',
    ...
    camera: { pos: [-11.0, 6.5, 12.0], target: [0, 0.6, 0], fov: 34 },
    state: { focus: ['hcal'], ghost: 0.08, explode: { 'staves.hcal': 1, 'endcaps.hcal': 1 } },
    labels: [
      { at: [0, 4114, 0], text: 'r = 4 114 mm', name: 'Stave' },
      { at: [-2000, 2000, -4537], text: '|z| = 4.54 m', name: 'Endcap' },
    ],
  },
  {
    id: 'yoke',
    ...
    camera: { pos: [14.0, 8.0, 17.0], target: [0, 0.8, 0], fov: 34 },
    state: { focus: ['yoke'], ghost: 0.08, explode: { 'staves.yoke': 1, 'endcaps.yoke': 1 } },
    labels: [
      { at: [0, 5896, 0], text: 'r = 5 896 mm', name: 'Stave' },
      { at: [3000, 3000, 5962], text: '|z| = 5.96 m', name: 'Endcap' },
    ],
  },
  {
    id: 'nozzles',
    ...
    camera: { pos: [8.0, 2.4, -14.0], target: [0, 0, -1.5], fov: 30 },
    state: { focus: ['nozzle', 'bch', 'beampipe'], ghost: 0.08, explode: { nozzles: 1 } },
    labels: [
      { at: [0, 550, -5950], text: 'r = 550 mm', name: 'Cladding' },
  ...
  },
  {
    ...
    lede: '',
    facts: [['Systems', '9'], ['Parts', '76'], ['Triangles', '1.9 M']],
    camera: { pos: [16.0, 9.5, 20.0], target: [0, 0.5, 0], fov: 36 },
    state: {
      focus: ALL,
      ghost: 1,
    ...
    labels: [
      { at: [0, 5896, 0], text: '', name: 'Yoke' },
      { at: [0, -4114, 0], text: '', name: 'HCal' },
      { at: [2125, 0, 0], text: '', name: 'ECal' },
      { at: [0, 1857, -1500], text: '', name: 'Solenoid' },
      { at: [0, 1486, 0], text: '', name: 'Tracker' },
      { at: [0, 400, -5950], text: '', name: 'Nozzle' },
    ],
  },
  {
    id: 'colophon',
